        ...
        <div className="two-col">
          ...
          <div className="card">
            <div className="card-header">
              ...
              <button className="pill-btn" onClick={() => router.push("/secadmin/analytics")}>
        ...
        <div className="two-col">
          ...
          <div className="card">
            <div className="card-header">
              ...
              <button className="pill-btn" onClick={() => router.push("/secadmin/reports")}>
                View all <Icon.ArrowRight />
              </button>
            </div>
            ...
            <button className="review-btn" onClick={() => router.push("/secadmin/reports")}>
              <Icon.FileText />
              Review Reports
            </button>
          </div>
