  ...
  const executeConfirmAction = async () => {
    ...
    try {
      ...
      if (confirmModal.type === "suspend") {
        endpoint = `${BASE_URL}/admin/users/deactivate/${confirmModal.userId}`;
      } else if (confirmModal.type === "resume") {
        endpoint = `${BASE_URL}/admin/users/activate/${confirmModal.userId}`;
      } else if (confirmModal.type === "delete") {
        endpoint = `${BASE_URL}/admin/users/delete/${confirmModal.userId}`;
        method = "DELETE";
      }
